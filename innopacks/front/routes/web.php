...
// route::get('/auth-google-redirect', [Account\LoginController::class,'google-redirect']);
// route::get('/auth-google-callback', [Account\LoginController::class,'google-callback']);
